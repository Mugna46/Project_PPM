    ...
    levelListEl.append(`
        <div class="card mb-3">
            <div class="card-body">
                ...
                <h5 class="card-subtitle mb-2 text-muted">${levelItem.picture_ids.length} artworks</h5>
                <p class="card-text">
                ${levelItem.description}
                </p>
                <a class="btn btn-primary btn-block" href="our_game.html?id=${levelItem.id}">PLAY</a>
            </div>
        </div>
    `);
  });
