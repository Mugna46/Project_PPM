...
$(async () => {
    ...
    if (check_tie == "false") {
        ...
        document.getElementById("testo_pose_fatte1").innerHTML = "Congratulations " + user.name + " you replicated well the following poses:";
        ...
        let listname1 = document.getElementById("playerlistscore1");
        let listname2 = document.getElementById("playerlistscore2");
